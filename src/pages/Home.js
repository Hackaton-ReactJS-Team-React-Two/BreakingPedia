        ...
        <div className="HeroHome__container">
          <div className="HeroHome__content container m-auto">
            <div className="HeroHome__quote mb-4">
              <i className="HerHome__quote-message mb-4">“{quote != null? quote[0].quote : ""}”</i>
              <div className="HerHome__quote-author">Author: {quote != null? quote[0].author : ""}</div>
            </div>
            <a className="btn btn-dark mx-auto d-block" href="#main-home">Welcome</a>
          </div>
        </div>
      </div>
      <main id="main-home">
        ...
        <button onClick={() => {
          setCount(count +1)
        }} className={`${visible? "d-block": "d-none"} btn btn-dark mx-auto my-5`}>Load more</button>
      </main>
    </Fragment>
  )
}
